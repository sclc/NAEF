...
class PowerIteration():
    ...
    def power_iteration_with_shifting_acc1 (self, mat, init_x, shifting_val, maxiters, tol):
        """ """
        lambda_eigen_list=[]
        mat_temp = mat.copy()
        #mat_temp = mat_temp - shifting_val * np.eye(mat.shape[0], mat.shape[1])
        mat_temp.setdiag( mat_temp.diagonal() - shifting_val )
        #print(mat_temp.diagonal())
