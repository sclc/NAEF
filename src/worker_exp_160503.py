...
class WorkerIterativeLinearSystemSolverCG_Exp_160503_A(Worker):
    ...
    def __init__(self, mat_path, tol, max_iteration):
        ...
        if mat_path == "":
            ...
            print("Done reading matrix {}, Row:{}, Col:{}".format( mat_path, 
                self._mat.shape[0], self._mat.shape[1]))
...
# main function for today's experiments 
    ...
    linear_system_solver_worker_test = WorkerIterativeLinearSystemSolverCG_Exp_160503_A(mat_path, 1e-5, 20)
