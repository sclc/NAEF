...
class WorkerIterativeLinearSystemSolverCG_Exp_160713(Worker):
...
# main function for today's experiments 
    ...
    dim = 10000
    left_semi_band ,right_semi_band = 10,10
    #big change , big cond
    #valmin = 0.
    valmin = 0.
    valmax = 100.
    #factor_diag = float(dim) 
    factor_diag =  5 * valmax 
    ...
    linear_system_solver_worker = WorkerIterativeLinearSystemSolverCG_Exp_160713("NeedMatGeneration")
