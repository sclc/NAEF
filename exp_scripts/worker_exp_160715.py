...
class WorkerIterativeLinearSystemSolverCG_Exp_160715(Worker):
...
# main function for today's experiments 
    ...
    linear_system_solver_worker = WorkerIterativeLinearSystemSolverCG_Exp_160715("NeedMatGeneration")
