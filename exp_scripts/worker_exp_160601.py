...
class WorkerIterativeLinearSystemSolverCG_Exp_160601(Worker):
...
# main function for today's experiments 
    ...
    linear_system_solver_worker_test = WorkerIterativeLinearSystemSolverCG_Exp_160601(mat_path)
